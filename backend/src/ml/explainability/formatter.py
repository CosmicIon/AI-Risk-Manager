...
class ExplanationFormatter:
    ...
    @staticmethod
    def format_for_audit(shap_result: list[dict[str, Any]], full_feature_vector: dict[str, float]) -> dict[str, Any]:
        return {
            "top_drivers": shap_result,
            "all_features": full_feature_vector
        }
