...
class FraudDetectionService:
    def __init__(self, case_repo: CaseRepository, kafka: TypedKafkaProducer, notification_svc: NotificationService):
    ...
    async def register_event(self, tenant_id: UUID, event_name: str, start: datetime, end: datetime):
        ...
        await self.kafka.send_event("tenant.config", event)
