...
from src.streaming.processors.transaction_processor import TransactionRecord, transactions_topic
from src.core.enums import AlertSeverity, SpikeClassification
from src.core.schemas.fraud_alert import AnomalyAlert

logger = logging.getLogger(__name__)

alerts_topic = app.topic("alerts.outbound", value_type=AnomalyAlert)
